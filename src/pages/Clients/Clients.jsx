...
const Clients = () => {
  const [testimonial54s, settestimonial54s] = React.useState([{id:1, img:"",title:'', description:''},{},{}]);
  return (
    <div id="Clients51">
      <div className="clients-header52">
      ...
      <div className="testimonials-container53">
        <div className="testimonial54">
      ...
      <div className="clients-logos55">
        <h3>Trusted By</h3>
        <div className="logos-container56">
