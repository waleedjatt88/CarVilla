...
const NewCars = () => {
  ...
  return (
    <div id="new-cars-container40">
      ...
      <div className="slideshow-container42">
        <div className={`car-slide fade ${currentSlide === 1 ? "active" : ""}`}>
          <img src={car1} alt="Ferrari 488 Superfast" className="car-image45" />
          <div className="car-info43">
            <h2>Ferrari 488 Superfast</h2>
            <p>
              The Ferrari 488 is a high-performance sports car produced by the
              Italian luxury car manufacturer Ferrari. It was introduced in
              2015.
            </p>
            <p>The Ferrari 812 Superfast, which has a V12 engine.</p>
            <a href="#" className="view-details44">
              View Details
            </a>
          </div>
        </div>
        <div className={`car-slide fade ${currentSlide === 2 ? "active" : ""}`}>
          <img src={car2} alt="Porsche 911 Turbo" className="car-image45" />
          <div className="car-info43">
        ...
        <div className={`car-slide fade ${currentSlide === 3 ? "active" : ""}`}>
          <img src={car3} alt="Lamborghini Huracan" className="car-image45" />
          <div className="car-info43">
        ...
        <div className={`car-slide fade ${currentSlide === 4 ? "active" : ""}`}>
          <img src={car4} alt="McLaren 720S" className="car-image45" />
          <div className="car-info43">
            <h2>McLaren 720S</h2>
            <p>
              The McLaren 720S is a high-performance supercar introduced in
              2017, succeeding the 650S.
            </p>
            <p>
      ...
      <div className="dots-container46">
        <span
