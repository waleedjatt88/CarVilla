...
const Services = () => {
  ...
  return (
    <section
      id="content-section64"
      ref={sectionRef}
      className={showAnimation ? "animate-fade-in-section" : ""}
    >
      <h2
        style={{ color: "black" }}
        className={showAnimation ? "animate-fade-in-down" : ""}
      >
        SERVICES
      </h2>
      <div className="cards65">
        <div className={`card66${showAnimation ? " animate-left" : ""}`}>
          <img
          ...
          <div className="card66-body">
            <h3>
              The largest car dealership with the best selection and unbeatable
              deals.
            </h3>
          </div>
        </div>
        <div className={`card66${showAnimation ? " animate-bottom" : ""}`}>
          <img
          ...
          <div className="card66-body">
            <h3>
              Enjoy peace of mind with our unlimited repair warranty—coverage
              you can count on.
            </h3>
          </div>
        </div>
        <div className={`card66${showAnimation ? " animate-right" : ""}`}>
          <img
          ...
          <div className="card66-body">
            <h3>
              Comprehensive insurance coverage tailored to protect what matters
              most.
            </h3>
          </div>
        </div>
